...
import { UsersRolesMatrix } from "./users-roles-matrix";
  ...
  return (
    <div className="flex flex-col gap-6 p-8 font-dm">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="font-bold text-3xl text-gray-900">Provider Management</h1>
          <p className="mt-1 text-gray-500">
            View and manage all providers across practices with role-based
            filtering
          </p>
        </div>
        <Link
      ...
      <div>
        ...
        <p className="mt-1 text-gray-500 text-sm">
          Functional permissions for each role across the PsyFlo platform
        </p>
      </div>
