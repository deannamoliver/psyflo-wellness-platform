...
export function LocationStudentsTab({
  ...
  const filtered = useMemo(() => {
    let result: StudentRecord[] = location.students;
    ...
    return result;
  }, [location.students, search, gradeFilter, statusFilter]);
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
      <div className="mb-6">
        <h2 className="font-bold text-gray-900 text-lg">Students</h2>
        <p className="mt-1 text-gray-500 text-sm">
          Manage and view all students at this location
        </p>
      </div>
