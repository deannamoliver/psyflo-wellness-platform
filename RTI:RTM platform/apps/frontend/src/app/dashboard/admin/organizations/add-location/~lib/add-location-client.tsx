...
import { Step2StudentAccess } from "./step-2-student-access";
import { Step3EmergencyServices } from "./step-3-emergency-services";
import { Step3SchoolContacts } from "./step-3-school-contacts";
import { Step4Platform } from "./step-4-platform";
      ...
      <div className="flex flex-col gap-6">
        ...
        {currentStep === 2 && (
          <>
            ...
            <Step2StudentAccess formData={formData} updateForm={updateForm} />
          </>
        )}
        {currentStep === 3 && (
          <>
            <Step3SchoolContacts formData={formData} updateForm={updateForm} />
            <Step3EmergencyServices
              formData={formData}
              updateForm={updateForm}
            />
          </>
        ...
        {currentStep === 4 && (
          <Step4Platform formData={formData} updateForm={updateForm} />
        )}
      </div>
