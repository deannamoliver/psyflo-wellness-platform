      ...
      <nav className="sticky top-0 z-50 flex h-16 items-center justify-between border-b bg-white px-6 font-dm">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="flex items-center gap-1 rounded-lg px-2 py-1.5 text-[#3D5C5C] text-xs transition-colors hover:bg-[#E6F5F5] hover:text-[#0D6B6B]"
          >
          ...
          <span className="text-[#7A9696] text-sm">Provider Portal</span>
        </div>
