    ...
    <div className="space-y-8 font-dm">
            ...
            <tr className="border-gray-100 border-b">
              <td className="px-4 py-4">
                <div className="flex items-center gap-3">
                  <RoleIcon
                    icon={<Crown className="size-4 text-purple-600" />}
                    bg="bg-purple-100"
                  />
                  <div>
                    <p className="font-medium text-gray-900">Admin (Psyflo)</p>
                    <p className="text-purple-600 text-xs">Platform Admin</p>
                  </div>
                </div>
              </td>
      ...
      <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
        <div className="flex items-center gap-3 rounded-t-lg border-gray-200 border-b bg-gray-900 px-6 py-4">
          ...
          <h3 className="font-semibold text-white">
            Patient Data Access (Dashboard Roles)
          </h3>
        </div>
              ...
              <td className="px-4 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 text-xs">Patient Care</p>
                  </div>
                </div>
              </td>
              <td className="px-4 py-4 text-center">
            ...
            <tr className="border-gray-100 border-b">
              <td className="px-4 py-4">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="font-medium text-gray-900">Practice Management</p>
