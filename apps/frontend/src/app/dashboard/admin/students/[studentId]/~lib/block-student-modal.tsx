...
import { blockStudent } from "./block-student-actions";
...
export function BlockStudentModal({
  open,
  onOpenChange,
  studentId,
  studentName,
      ...
      <DialogContent className="max-h-[90vh] max-w-lg overflow-y-auto bg-white font-dm">
        ...
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
          <p className="text-amber-800 text-sm">
            Blocking <strong>{studentName}</strong> will immediately prevent
            them from accessing the platform, including chat, check-ins, and
            assessments. This action can be reversed.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Textarea
              ...
              placeholder="Provide a detailed explanation for blocking this student..."
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Textarea
              ...
              placeholder="Add any internal notes (not visible to the student)..."
              className="min-h-[80px] resize-none border-gray-200 bg-white font-dm"
              rows={3}
            />
          </div>
          ...
          <div className="flex flex-col gap-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
            ...
            <ConfirmCheckbox
              ...
              label="I confirm that blocking this student is necessary"
            />
            <ConfirmCheckbox
            ...
            <ConfirmCheckbox
              ...
              label="I understand the student will lose access"
            />
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-3 border-gray-200 border-t pt-4">
          ...
          >
            {isPending ? "Blocking..." : "Block Student Now"}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
