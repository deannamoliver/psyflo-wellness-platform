...
export const EXPLORE_TOPICS: ExploreTopic[] = [
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        description:
          "Spot stress overload and reset before you feel drained, exhausted, or checked out.",
      ...
      },
      {
        ...
        description:
          "Understand sadness, what can make it worse, and how to get support and feel better.",
      ...
      },
      {
        ...
        description:
          "Notice anger triggers and practice steps to cool down without blowing up.",
      ...
      },
      {
        ...
        description:
          "Build tools to handle intense emotions safely and get back to feeling steady.",
      ...
      },
      {
        ...
        description:
          "Learn to name, recognize, and understand your emotions and why they happen.",
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        description:
          "Understand urges and impulses and build skills to pause and make better choices.",
      ...
      },
      {
        ...
        description:
          "Navigate peer pressure and make choices that feel right for you.",
      ...
      },
      {
        ...
        description:
          "Get clear on the risks and how to stay safe around substances and vaping.",
    ...
    subcategories: [
      {
        ...
        description:
          "Improve focus and manage distractions so you can get things done.",
      ...
      },
      {
        ...
        description:
          "Understand why we put things off and how to start and keep going.",
      ...
      },
      {
        ...
        description:
          "Break down problems and find step-by-step ways to solve them.",
    ...
    subcategories: [
      {
        ...
        title: "Friend Drama",
        description:
          "Navigate arguments, fallouts, and drama with friends in healthier ways.",
      ...
      },
      {
        ...
        description:
          "Cope with feeling alone and find ways to connect and belong.",
      ...
      },
      {
        ...
        description:
          "Build confidence to meet new people and deepen friendships.",
      ...
      },
      {
        ...
        description:
          "Use social media in ways that support your mood and relationships.",
    ...
    subcategories: [
      {
        ...
        description:
          "Navigate arguments and tension at home in healthier ways.",
      ...
      },
      {
        ...
        description:
          "Deal with family expectations and feeling like no one gets you.",
      ...
      },
      {
        ...
        description:
          "Cope with big changes at home like moving, divorce, or new family members.",
    ...
    subcategories: [
      {
        ...
        description:
          "Handle disagreements and fights in healthier ways and find resolution.",
      ...
      },
      {
        ...
        description:
          "Recognize bullying and cyberbullying and know what to do and who can help.",
      ...
      },
      {
        ...
        description:
          "Build confidence to speak up and set boundaries when others cross the line.",
    ...
    subcategories: [
      {
        ...
        description:
          "Build a kinder inner voice and feel better about yourself.",
      ...
      },
      {
        ...
        title: "Body Image",
        description:
          "Feel more at peace with your body and handle pressure about how you look.",
    ...
    subcategories: [
      {
        ...
        description:
          "Understand your sleep and energy patterns and find ways to rest and recharge.",
      ...
      },
      {
        ...
        description:
          "Navigate challenges with food, eating habits, and your relationship with meals.",
      ...
      },
      {
        ...
        description:
          "Take care of your body through movement, activity, and physical wellness.",
    ...
    subcategories: [
      {
        ...
        title: "Grief & Loss",
        description:
          "Process grief and loss at your own pace and find support along the way.",
      ...
      },
      {
        ...
        description:
          "Handle the stress of changing schools, new environments, and fresh starts.",
      ...
      },
      {
        ...
        description:
          "Cope with shifts in your family like divorce, moving, or new family dynamics.",
      ...
      },
      {
        ...
        description:
          "Manage worries about college, career choices, and what comes next.",
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        description:
          "Have hard conversations and express your feelings in healthy ways.",
      ...
      },
      {
        ...
        description:
          "Listen in a way that helps others feel heard and strengthens connection.",
    ...
    subcategories: [
      {
        ...
        title: "Guilt & Shame",
        description:
          "Handle guilt and shame in healthy ways without getting stuck.",
      ...
      },
      {
        ...
        description:
          "Learn from mistakes and rebuild trust with others over time.",
