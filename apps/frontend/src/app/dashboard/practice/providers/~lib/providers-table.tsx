      ...
      <div className="flex items-center justify-between border-b px-5 py-4">
        <div className="flex items-center gap-3">
          <h3 className="text-sm font-semibold text-gray-900">
            All Providers <span className="ml-1 text-gray-500">({providers.length})</span>
          </h3>
          <button
            type="button"
          ...
          <tbody className="divide-y">
            {paginated.length === 0 ? (
              ...
              paginated.map((provider) => (
                <tr key={provider.id} className="transition-colors hover:bg-gray-50/50">
                  ...
                  <td className="px-4 py-3">
                    <span className="font-semibold text-gray-900 text-sm">{provider.patientCount}</span>
                  </td>
                  <td className="px-4 py-3">
                    <span
                      className={cn(
                  ...
                  <td className="px-4 py-3 text-sm text-gray-500">
                    {format(new Date(provider.joinedAt), "MMM d, yyyy")}
                  </td>
                  <td className="px-4 py-3">
