...
export default function ProviderClaimAccountPage() {
  ...
  const handleContinue = async () => {
    ...
    sessionStorage.setItem("provider_onboarding_firstName", firstName);
    sessionStorage.setItem("provider_onboarding_lastName", lastName);
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4 pt-8 md:px-8">
        <div className="w-full max-w-md">
          ...
          <p className="mb-8 text-center text-gray-500 md:text-lg">
            Enter your information to get started as a provider
          </p>
