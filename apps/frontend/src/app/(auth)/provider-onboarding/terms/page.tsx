...
export default function ProviderTermsPage() {
  ...
  const handleContinue = async () => {
    ...
    setIsLoading(true);
    // Store agreement
    sessionStorage.setItem("provider_onboarding_termsAgreed", "true");
    sessionStorage.setItem("provider_onboarding_privacyAgreed", "true");
    
    router.push("/provider-onboarding/complete");
  };
              ...
              <div className="mb-4 flex items-start justify-between">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    Our terms outline how you can use Psyflo and what we expect from providers.
                  </p>
                </div>
                <Link
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5">
              <div className="mb-4 flex items-start justify-between">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    Learn how we collect, use, and protect personal information.
                  </p>
                </div>
                <Link
                  href="/privacy-policy"
