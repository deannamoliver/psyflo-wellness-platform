...
export default function ProviderCrisisDisclosurePage() {
        ...
        <div className="w-full max-w-xl">
          ...
          <div className="mb-8 rounded-2xl border-2 border-amber-200 bg-amber-50 p-6">
            ...
            <p className="text-center text-gray-600">
              Patient check-ins are <strong>not monitored in real time</strong>. If a patient indicates they are in crisis, 
              you will receive an alert, but immediate intervention should follow your practice's existing crisis protocols.
            </p>
          </div>

          {/* Crisis Resources */}
          <div className="mb-8 space-y-3">
            <h2 className="mb-4 font-semibold text-gray-900 text-lg">Resources for patients in crisis:</h2>
          ...
          <div className="flex justify-center">
            <Button
              onClick={() => router.push("/provider-onboarding/terms")}
